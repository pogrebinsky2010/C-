 ...
 * Modified by Talaba Pogrebinsky
 *
 *******************************/
...
enum Category { ONES = 1, TWOS, THREES, FOURS, FIVES, SIXES, THREE_OF_A_KIND,
                    ...
                    YAHTZEE, CHANCE };
//function created by: Talaba Pogrebinsky
...
int scoreSmallStraight(int ones, int twos, int threes, int fours, int fives, int sixes)
{
    ...
    if(ones == 1 && twos == 1 and threes == 1 and fours == 1 and fives ==1)
    {
        int score;
        score = 30;
        return score;
...
int scoreLargeStraight(int ones, int twos, int threes, int fours, int fives, int sixes)
{
    if(sixes == 1 && twos == 1 and threes == 1 and fours == 1 and fives ==1)
    {
        int score;
        score = 40;
        return score;
...
int scoreThreeOfAKind(int ones, int twos, int threes, int fours, int fives, int sixes)
{
    ...
    {
        int total;
        total = sumOfDice(ones,  twos,  threes,  fours,  fives,  sixes);
        return total;
    }
    else
        return 0;
...
int scoreYahtzee(int ones, int twos, int threes, int fours, int fives, int sixes)
{
    int total = sumOfDice(ones, twos, threes, fours, fives, sixes);
...
{
    int score;
    score = sumOfDice(ones, twos, threes, fours, fives, sixes);
    return score;
}
